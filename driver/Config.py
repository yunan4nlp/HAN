...
class Configurable(object):
	...
	@property
	def save_encoder_path(self):
		return self._config.get('Save','save_encoder_path')
	@property
	def save_decoder_path(self):
		return self._config.get('Save','save_decoder_path')
	@property
	...
	@property
	def encoder(self):
		return self._config.get('Network','encoder')
	@property
	...
	@property
	def role_dims(self):
		return self._config.getint('Network','role_dims')
	@property
	def tag_dims(self):
	...
	def max_sent_length(self):
		return self._config.getint('Run','max_sent_length')
	@property
	def max_turn_length(self):
		return self._config.getint('Run','max_turn_length')
